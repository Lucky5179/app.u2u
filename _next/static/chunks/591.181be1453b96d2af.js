!(function () {
  try {
    ...
    e &&
      ...
      (t._sentryDebugIds[e] = "d47e2265-d873-4009-a132-4ca43fd97bcd"),
      (t._sentryDebugIdIdentifier =
        "sentry-dbid-d47e2265-d873-4009-a132-4ca43fd97bcd"));
  } catch (t) {}
})(),
...
\f\r"'\`<>=]|("|')|))|$)`,
          ...
          for (let e = 0; e < r; e++) {
            ...
            n +=
              l === S
                ? r + O
                : c >= 0
                ? (o.push(a), r.slice(0, c) + A + r.slice(c) + _ + h)
                  ...
                  for (let e of o.getAttributeNames())
                    if (e.endsWith(A) || e.startsWith(_)) {
                      ...
                      if ((t.push(e), void 0 !== r)) {
                        let t = o.getAttribute(r.toLowerCase() + A).split(_),
                          e = /([.?@])?(.*)/.exec(r);
                        a.push({
                          type: 1,
                          index: i,
        ...
        function tH(t, e, r, o) {
          ...
          let i = (e) =>
            (function (t, e, r, o, i) {
              ...
              let a = 0;
              do
                (n = tW((l = e + (r - e) / 2), o, i) - t) > 0
                  ? (r = l)
                  : (e = l);
              while (Math.abs(n) > 1e-7 && ++a < 12);
              return l;
            })(e, 0, 1, t, r);
          return (t) => (0 === t || 1 === t ? t : tW(i(t), e, o));
        }
        let tZ =
            (t, e = "end") =>
            (r) => {
              ...
              for (let t in e) {
                ...
                let d = (function (t, e, r, o = {}, i) {
                  ...
                  let C = ep(e),
                    ...
                    E = t3.get(C);
                  return (
                    tO($.animation, !(tN(m) && $.generator) && !1 !== o.record),
                    () => {
                      let n = () => {
                          var e, r;
                          return null !==
                      ...
                      if (
                        ...
                        E &&
                          (b = b.map((t) => (tS(t) ? E.toDefaultUnit(t) : t))),
                          1 === b.length &&
                        ...
                        let e = b[b.length - 1];
                        eg.set(t, C, E && tS(e) ? E.toDefaultUnit(e) : e);
                      }
                      return (
                        s &&
                          a(
        ...
        var ex = r(35819),
          ...
          ek = (t, e) => {
            ...
            if (e$) for (var r of e$(e)) eA.call(e, r) && e_(t, r, e[r]);
            return t;
          };
        function eO() {
          return {
        ...
        (eN.styles = [eI.globalCss, eT]),
          eR([tp({ type: Boolean })], eN.prototype, "disabled", 2),
          eR([tp()], eN.prototype, "iconLeft", 2),
          eR([tp()], eN.prototype, "iconRight", 2),
          eR([tp()], eN.prototype, "onClick", 2),
          eR([tp()], eN.prototype, "variant", 2),
          (eN = eR([th("wcm-button")], eN));
        ...
        let e8 = {
            ...
            handleMobileLinking(t, e = "_self") {
              ...
              e8.setRecentWallet(t),
                r &&
                  (function (t) {
                    if (n) {
                      let r = t$.zv.formatNativeUrl(n, t, i);
                      t$.zv.openHref(r, e);
                    } else if (l) {
                      let r = t$.zv.formatUniversalUrl(l, t, i);
                      t$.zv.openHref(r, e);
                    }
                  })(r);
            },
            handleAndroidLinking() {
              ...
              t &&
                ...
                t$.zv.openHref(t, t$.zv.isTelegram() ? "_blank" : "_self"));
            },
            async handleUriCopy() {
              let { walletConnectUri: t } = t$.OptionsCtrl.state;
              if (t)
        ...
        var r_ = Object.defineProperty,
          ...
          rO = (t, e, r, o) => {
            for (
              var i, n = o > 1 ? void 0 : o ? rk(e, r) : e, l = t.length - 1;
              l >= 0;
              l--
            )
              (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
        ...
        (rN.styles = [eI.globalCss, rT]),
          rR([tp()], rN.prototype, "onClick", 2),
          rR([tp()], rN.prototype, "name", 2),
          rR([tp()], rN.prototype, "walletId", 2),
          rR([tp()], rN.prototype, "label", 2),
          rR([tp()], rN.prototype, "imageId", 2),
          rR([tp({ type: Boolean })], rN.prototype, "installed", 2),
          rR([tp({ type: Boolean })], rN.prototype, "recent", 2),
          (rN = rR([th("wcm-wallet-button")], rN));
        ...
        let rj = class extends tc {
          ...
          render() {
            ...
            let e = (null == (t = this.imageUrl) ? void 0 : t.length)
              ? this.imageUrl
              : e8.getWalletIcon({ id: this.walletId, image_id: this.imageId });
            return H`${
              e.length
        ...
        rW([tg()], rH.prototype, "preload", 2),
          (rH = rW([th("wcm-explorer-context")], rH));
          ...
          render() {
            ...
            return (null != t ? t : e)
              ? H`<div><wcm-text variant="small-regular" color="secondary">By connecting your wallet to this app, you agree to the app's ${
                  t
                    ? H`<a href="${t}" target="_blank" rel="noopener noreferrer">Terms of Service</a>`
                    : null
                } ${t && e ? "and" : null} ${
                  e
                    ? H`<a href="${e}" target="_blank" rel="noopener noreferrer">Privacy Policy</a>`
                    : null
                }</wcm-text></div>`
              : null;
          }
        ...
        let ok = class extends tc {
          viewTemplate() {
            return t$.zv.isAndroid() && !t$.zv.isTelegram()
        ...
        let oP = class extends tc {
          ...
          onFormatAndRedirect(t) {
            ...
            if (o) {
              ...
              let e = t$.zv.formatUniversalUrl(i, t, r);
        ...
        let oz = class extends tc {
          ...
          onFormatAndRedirect(t, e = !1) {
            let { mobile: r, name: o } = t$.zv.getWalletRouterData(),
              ...
              l = t$.zv.isTelegram() ? "_blank" : "_self";
            if (
              ((t =
                t$.zv.isTelegram() && t$.zv.isAndroid()
          ...
          openMobileApp(t = !1) {
            ...
            e && this.onFormatAndRedirect(e, t), e8.setRecentWallet(r);
          }
          onGoToAppStore(t) {
            t && t$.zv.openHref(t, "_blank");
          }
        ...
        (oz.styles = [eI.globalCss, oD]),
          oU([tg()], oz.prototype, "isError", 2),
          (oz = oU([th("wcm-mobile-connecting-view")], oz));
        let oW = d`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
        ...
        (o4.styles = [eI.globalCss, o0]),
          ...
          o5([th("wcm-web-connecting-view")], o4);
      },
    },
  ]);
